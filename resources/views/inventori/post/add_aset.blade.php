            ...
            <div class="w-full h-full lg:mx-auto lg:w-1/2">
                <form action="" id="form-add-aset" method="POST" enctype="multipart/form-data" class="flex flex-col">
                    ...
                    <div class="mb-6 flex flex-col lg:flex-row lg:mx-4">
                        <label for="name" class="block mb-2 font-medium text-gray-900 lg:w-2/6 lg:my-auto lg:mr-16">Kode Barang</label>
                    ...
                    <div class="mb-6 flex flex-col lg:flex-row lg:mx-4">
                        <label for="name" class="block mb-2 font-medium text-gray-900 lg:w-2/6 lg:my-auto lg:mr-16">Nama Barang</label>
                        <input type="text" id="name" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:shadow-md block w-full p-2.5 lg:w-3/4 lg:h-8 lg:border-slate-400" required>
                    </div>
                    <div class="mb-6 flex flex-col lg:flex-row lg:mx-4">
                        <label for="name" class="block mb-2 font-medium text-gray-900 lg:w-2/6 lg:my-auto lg:mr-16">Merek Barang</label>
                        <input type="text" id="name" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:shadow-md block w-full p-2.5 lg:w-3/4 lg:h-8 lg:border-slate-400" required>
                    </div>
                    <div class="mb-6 flex flex-col lg:flex-row lg:mx-4">
                        <label for="name" class="block mb-2 font-medium text-gray-900 lg:w-2/6 lg:my-auto lg:mr-16">Satuan Barang</label>
                        <input type="text" id="name" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:shadow-md block w-full p-2.5 lg:w-3/4 lg:h-8 lg:border-slate-400" required>
                    </div>
                    <div class="mb-6 flex flex-col lg:flex-row lg:mx-4">
                        <label for="name" class="block mb-2 font-medium text-gray-900 lg:w-2/6 lg:my-auto lg:mr-16">Kategori Barang</label>
                        <input type="text" id="name" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:shadow-md block w-full p-2.5 lg:w-3/4 lg:h-8 lg:border-slate-400" required>
                    </div>
                    <div class="mb-6 flex flex-col lg:flex-row lg:mx-4">
                        <label for="name" class="block mb-2 font-medium text-gray-900 lg:w-2/6 lg:my-auto lg:mr-16">File Gambar Barang</label>
                        <input type="file" id="name" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:shadow-md block w-full p-2.5 lg:w-3/4 lg:h-8 lg:border-slate-400 cursor-pointer file:rounded-md lg:px-2.5 lg:pt-2 lg:file:hidden" required>
                    </div>
                    <div class="mb-6 flex flex-col lg:flex-row lg:mx-4">
                    ...
                    <div class="mb-6 flex lg:flex-row lg:mx-4 place-content-between">
                        <a href="/inventory/aset" class="flex group">
