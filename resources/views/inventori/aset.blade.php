<x-app-layout title="Aset Barang">
    ...
    <div class="flex flex-col">
        <div class="flex pb-2 border-b border-slate-300 place-content-between">
            <div class="pt-1 font-semibold text-slate-700 uppercase">Aset Barang</div>
            {{-- Tambah Aset Mobile Mode --}}
            <div class="md:hidden">
                <a href="/post/add_aset" class="flex">
                ...
                <table class="w-full text-sm text-left">
                    ...
                    <tbody>
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="px-6 py-3">B0001</td>
                            <td class="px-6 py-3">Kursi Lipat</td>
                            <td class="px-6 py-3 text-center">529</td>
                            <td class="px-6 py-3 text-center">Buah</td>
                            <td class="px-6 py-3">
