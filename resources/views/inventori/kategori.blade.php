<x-app-layout title="Kategori Barang">
    ...
    <div class="flex flex-col">
        <div class="flex pb-2 border-b border-slate-300 place-content-between">
            <div class="pt-1 font-semibold text-slate-700 uppercase">Kategori Barang</div>
            {{-- Tambah Aset Mobile Mode --}}
            <div class="md:hidden">
                <a href="/post/add_kategori" class="flex">
        ...
        <div class="flex place-content-between">
            ...
            <div class="hidden my-4 md:block">
                <a href="/post/add_kategori" class="flex group">
                ...
                <table class="w-full text-sm text-left">
                    <thead class="bg-slate-400 uppercase text-slate-100">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3">Kode Kategori</th>
                    ...
                    <tbody>
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="px-6 py-3">K0001</td>
                            <td class="px-6 py-3">Kursi Kuliah</td>
                            <td class="px-6 py-3 text-center">529</td>
                            <td class="px-6 py-3">
