                ...
                <table class="w-full text-sm text-left">
                    <thead class="bg-slate-400 uppercase text-slate-100">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3">Kode Supplier</th>
                    ...
                    <tbody>
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="px-6 py-3">S0001</td>
                            <td class="px-6 py-3">Calvin Computer</td>
                            <td class="px-6 py-3">jl kutagara no 53 jagra satu</td>
                            <td class="px-6 py-3 text-center">+628xxxxxxxxxxx</td>
                            <td class="px-6 py-3">
