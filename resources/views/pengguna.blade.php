<x-app-layout title="Pengguna">
    ...
    <div class="flex flex-col">
        <div class="flex pb-2 border-b border-slate-300 place-content-between">
            <div class="pt-1 font-semibold text-slate-700 uppercase">Pengguna</div>
                ...
                <table class="w-full text-sm text-left">
                    <thead class="bg-slate-400 uppercase text-slate-100">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3">Kode Pengguna</th>
                    ...
                    <tbody>
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td scope="col" class="px-6 py-3">U007</td>
                            <td scope="col" class="px-6 py-3">Gita Puspita</td>
                            <td scope="col" class="px-6 py-3">gitatea</td>
                            <td scope="col" class="px-6 py-3">081911111111</td>
                            <td scope="col" class="px-6 py-3">Petugas</td>
                            <td class="px-6 py-3">
