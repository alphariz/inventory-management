<x-app-layout title="Peminjaman">
    ...
    <div class="flex flex-col">
        <div class="flex pb-2 border-b border-slate-300 place-content-between">
            <div class="pt-1 font-semibold text-slate-700 uppercase">Peminjaman</div>
                ...
                <table class="w-full text-sm text-left">
                    ...
                    <tbody>
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td scope="col" class="px-6 py-3">PJ00002</td>
                            <td scope="col" class="px-6 py-3">John Doe</td>
                            <td scope="col" class="px-6 py-3">Kursi Tempur</td>
