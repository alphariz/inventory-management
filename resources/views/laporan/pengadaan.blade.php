<x-app-layout title="Pengadaan">
    ...
    <div class="flex flex-col">
        <div class="flex pb-2 border-b border-slate-300 place-content-between">
            <div class="pt-1 font-semibold text-slate-700 uppercase">Pengadaan</div>
                ...
                <table class="w-full text-sm text-left">
                    <thead class="bg-slate-400 uppercase text-slate-100">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3">Kode Pengadaan</th>
                            <th scope="col" class="px-6 py-3">Nama Barang</th>
                            <th scope="col" class="px-6 py-3">Supplier</th>
                            <th scope="col" class="px-6 py-3">Keterangan</th>
                            <th scope="col" class="px-6 py-3 text-center">Total Barang</th>
                            <th scope="col" class="px-6 py-3 text-center">Total Belanja (Rp)</th>
                    ...
                    <tbody>
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="px-6 py-3 text-center">23-06-2021</td>
                            <td class="px-6 py-3">BB00068</td>
                            <td class="px-6 py-3">Meja komputer</td>
                            <td class="px-6 py-3">Calvin Computer</td>
                            <td class="px-6 py-3">Belanja Baru</td>
                            <td class="px-6 py-3 text-center">70</td>
                            <td class="px-6 py-3 text-right">2.511.250.000</td>
                            <td class="px-6 py-3">
