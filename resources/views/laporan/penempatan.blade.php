<x-app-layout title="Penempatan">
    ...
    <div class="flex flex-col">
        <div class="flex pb-2 border-b border-slate-300 place-content-between">
            <div class="pt-1 font-semibold text-slate-700 uppercase">Penempatan</div>
                ...
                <table class="w-full text-sm text-left">
                    ...
                    <tbody>
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="px-6 py-3">PB00068</td>
                            <td class="px-6 py-3">Meja Komputer</td>
                            <td class="px-6 py-3">Lab komputer</td>
                            <td class="px-6 py-3">Komputer Baru</td>
