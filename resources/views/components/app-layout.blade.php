        ...
        <div class="hidden w-1/3 lg:w-1/5 md:block md:bg-slate-400">
            <div class="flex flex-col">
                ...
                <div class="flex min-w-full border-b-2 shadow-md place-content-between h-14 bg-sky-900 border-slate-100">
                    ...
                    <a href="#home" class="flex flex-col min-w-full my-auto font-semibold text-slate-100 lg:flex-row lg:text-xl">
                ...
                <div class="flex w-full border-y border-slate-400 h-14 bg-slate-500 hover:bg-sky-600 active:bg-sky-800 hover:border-y hover:border-slate-300">
                    ...
                    <a href="#home" class="w-full pb-1 my-auto text-lg text-slate-100">Home</a>
                </div>
                <!-- End Home -->
                <!-- Inventaris -->
                <div class="relative group">
                    ...
                    <div class="hidden w-full peer-checked:flex h-14 bg-slate-600 hover:bg-sky-900 hover:border-y hover:border-slate-400 active:bg-sky-700">
                        ...
                        <a href="#aset_barang" class="w-full pb-1 my-auto text-lg text-slate-100">
                            Aset Barang
                        </a>
                    </div>
                    <!-- End Aset Barang -->
                    ...
                    <div class="hidden w-full peer-checked:flex h-14 bg-slate-600 hover:bg-sky-900 hover:border-y hover:border-slate-400 active:bg-sky-700">
                        ...
                        <a href="#kategori_barang" class="w-full pb-1 my-auto text-lg text-slate-100">
                            Kategori Barang
                        </a>
                    </div>
                    <!-- End Kategori Barang -->
                    ...
                    <div class="hidden w-full peer-checked:flex h-14 bg-slate-600 hover:bg-sky-900 hover:border-y hover:border-slate-400 active:bg-sky-700">
                        ...
                        <a href="#supplier_barang" class="w-full pb-1 my-auto text-lg text-slate-100">
                            Supplier Barang
                        </a>
                    </div>
                    <!-- End Supplier Barang -->
                        ...
                        <div class="mx-4 my-auto md:hidden">
                            <label for="" class="group">
                                ...
                                <ul class="absolute hidden mt-4 -mx-4 peer-checked:block">
                                    ...
                                    <li class="w-screen h-12 py-2 text-lg font-semibold text-center border-y text-slate-50 border-slate-50 bg-sky-600 hover:bg-sky-900 active:bg-sky-300 active:text-slate-700">
                                        <a href="#aset_barang">Aset Barang</a>
                                    </li>
                                    <li class="w-screen h-12 py-2 text-lg font-semibold text-center border-y text-slate-50 border-slate-50 bg-sky-600 hover:bg-sky-900 active:bg-sky-300 active:text-slate-700">
                                        <a href="#kategori_barang">Kategori Barang</a>
                                    </li>
                                    <li class="w-screen h-12 py-2 text-lg font-semibold text-center border-y text-slate-50 border-slate-50 bg-sky-600 hover:bg-sky-900 active:bg-sky-300 active:text-slate-700">
                                        <a href="#supplier_barang">Supplier Barang</a>
                                    </li>
                                    <li class="w-screen h-12 py-2 text-lg font-semibold text-center border-y text-slate-50 border-slate-50 bg-sky-600 hover:bg-sky-900 active:bg-sky-300 active:text-slate-700">
