<x-app-layout title="Departemen">
    ...
    <div class="flex flex-col">
        <div class="flex pb-2 border-b border-slate-300 place-content-between">
            <div class="pt-1 font-semibold text-slate-700 uppercase">Departemen</div>
                ...
                <table class="w-full text-sm text-left">
                    <thead class="bg-slate-400 uppercase text-slate-100">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3">Kode Departemen</th>
                            <th scope="col" class="px-6 py-3">Nama Departemen</th>
                            <th scope="col" class="px-6 py-3">Keterangan</th>
                            <th scope="col" class="px-6 py-3 text-center">Jumlah Ruangan</th>
                    ...
                    <tbody>
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="px-6 py-3">D0001</td>
                            <td class="px-6 py-3">Umum</td>
                            <td class="px-6 py-3">Inventory</td>
                            <td class="px-6 py-3 text-center">36</td>
                            <td class="px-6 py-3">
